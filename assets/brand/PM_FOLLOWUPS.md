...
4. **Official Botox Cosmetic / Juvéderm trademark logos** — these were added to the Drive folder but we have NOT used them on the site. Displaying manufacturer trademark logos (e.g., as "as seen with" trust marks) typically requires following Allergan's brand-usage guidelines; please confirm if/how you'd like these used before we add them.
